...
// constructor
NCPA::ProcessOptionsCBB::ProcessOptionsCBB(AnyOption *opt)
{
  ...
  plot_flg           = opt->getFlag( "plot");         // plot flag to allow plotting of results 
  ...
  if (pprop_s2r_flg) {
      ...
      if ( opt->getValue( "range_R_km" ) != NULL ) {
          ...
          if (RR<=0) {
              delete opt;
              throw invalid_argument( "Option --range_R_km should be greater than 0.0!" );
          }
      }
      else {
          delete opt;
...
//get functions
bool NCPA::ProcessOptionsCBB::getW_disp_src2rcv_flg() {
  return w_disp_src2rcv_flg;
}

std::string   NCPA::ProcessOptionsCBB::getOut_disp_file() {
  return out_disp_file;
}

bool   NCPA::ProcessOptionsCBB::getW_disp_flg() {
  return w_disp_flg;
}

std::string   NCPA::ProcessOptionsCBB::getPprop_grid_dirname() {
  return pprop_grid_dirname;
}

bool   NCPA::ProcessOptionsCBB::getPprop_grid_flg() {
  return pprop_grid_flg;
}

std::string   NCPA::ProcessOptionsCBB::getPprop_s2r_disp_file() {
  return pprop_s2r_disp_file;
}

bool   NCPA::ProcessOptionsCBB::getPprop_s2r_flg() {
  return pprop_s2r_flg;
}

bool   NCPA::ProcessOptionsCBB::getPprop_s2r_grid_flg() {
  return pprop_s2r_grid_flg;
}

//bool   NCPA::ProcessOptionsCBB::getUsemodess_flg() {
//  return usemodess_flg;
//}

double NCPA::ProcessOptionsCBB::getZ_min() {
  return z_min;
}

double NCPA::ProcessOptionsCBB::getMax_celerity() {
  return max_cel;
}

double NCPA::ProcessOptionsCBB::getRR() {
  return RR;
}

double NCPA::ProcessOptionsCBB::getR_start() {
  return R_start;
}

double NCPA::ProcessOptionsCBB::getR_end() {
  return R_end;
}

double NCPA::ProcessOptionsCBB::getDR() {
  return DR;
}

std::string   NCPA::ProcessOptionsCBB::getAtmosfile() {
  return atmosfile;
}

std::string   NCPA::ProcessOptionsCBB::getWindUnits() {
  return wind_units;
}

std::string   NCPA::ProcessOptionsCBB::getAtmosfileorder() {
  return atmosfileorder;
}

int    NCPA::ProcessOptionsCBB::getSkiplines() {
  return skiplines;
}

double NCPA::ProcessOptionsCBB::getAzimuth() {
  return azi;
}

double NCPA::ProcessOptionsCBB::getMaxrange() {
  return maxrange;
}

double NCPA::ProcessOptionsCBB::getMaxheight() {
  return maxheight;
}

double NCPA::ProcessOptionsCBB::getSourceheight() {
  return sourceheight;
}

double NCPA::ProcessOptionsCBB::getReceiverheight() {
  return receiverheight;
}

int    NCPA::ProcessOptionsCBB::getNrng_steps() {
  return Nrng_steps;
}

int    NCPA::ProcessOptionsCBB::getNz_grid() {
  return Nz_grid;
}

std::string   NCPA::ProcessOptionsCBB::getGnd_imp_model() {
  return gnd_imp_model;
}

int    NCPA::ProcessOptionsCBB::getLamb_wave_BC() {
  return Lamb_wave_BC;
}

int    NCPA::ProcessOptionsCBB::getNfreq() {
  return Nfreq;
}

double NCPA::ProcessOptionsCBB::getF_min() {
  return f_min;
}

double NCPA::ProcessOptionsCBB::getF_step() {
  return f_step;
}

double NCPA::ProcessOptionsCBB::getF_max() {
  return f_max;
}

double NCPA::ProcessOptionsCBB::getF_center() {
  return f_center;
}

std::string NCPA::ProcessOptionsCBB::getWaveform_out_file() {
  return waveform_out_file;
}

double NCPA::ProcessOptionsCBB::getR_start_km() {
  return R_start_km;
}

double NCPA::ProcessOptionsCBB::getWidth_km() {
  return width_km;
}

double NCPA::ProcessOptionsCBB::getHeight_km() {
  return height_km;
}

double NCPA::ProcessOptionsCBB::getTmstep() {
  return tmstep;
}

int    NCPA::ProcessOptionsCBB::getNtsteps() {
  return ntsteps;
}

std::string   NCPA::ProcessOptionsCBB::getFrame_file_stub() {
  return frame_file_stub;
}		
			
std::string   NCPA::ProcessOptionsCBB::getSrcfile() {
  return srcfile;
}

int    NCPA::ProcessOptionsCBB::getSrc_flg() {
  return src_flg;
}

bool   NCPA::ProcessOptionsCBB::getPlot_flg() {
  return plot_flg;
}
