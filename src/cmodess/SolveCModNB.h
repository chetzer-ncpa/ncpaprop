#ifndef _SolveCModNB_H_
#define _SolveCModNB_H_
...
namespace NCPA {
  class SolveCModNB {
    public:           
      ...
      int getCModalTrace(int nz, double z_min, double sourceheight, double receiverheight, double dz, NCPA::SampledProfile *p, double admittance, double freq, double azi, complex<double> *diag, double *k_min, double *k_max, double *alpha, bool turnoff_WKB);		
      ...
      int doSelect(int nz, int n_modes, double k_min, double k_max, complex<double> *k2, complex<double> **v, complex<double> *k_s, complex<double> **v_s, int *select_modes);

      int getTLoss1D(int select_modes, double dz, int n_r, double dr, double z_src, double z_rcv, double *rho, complex<double> *k_s, complex<double> **v_s);      
      
      int getTLoss1DNx2(double azimuth, int select_modes, double dz, int n_r, double dr, double z_src, double z_rcv,  double *rho, complex<double> *k_s, complex<double> **v_s, bool Nx2, int iter);      
      ...
      int writePhaseSpeeds(int select_modes, double freq, std::complex<double> *k_s);

      int writeEigenFunctions(int nz, int select_modes, double dz, complex<double> **v_s);
