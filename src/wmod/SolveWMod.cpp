...
// constructor 2
//
NCPA::SolveWMod::SolveWMod(ParameterSet *param, Atmosphere1D *atm_profile)
{
...
void NCPA::SolveWMod::setParams(ParameterSet *param, Atmosphere1D *atm_prof)
{		
  ...
  // @todo read user attenuation file instead
...
int NCPA::SolveWMod::getModalTrace(int nz, double z_min, double sourceheight, double receiverheight, 
...
int NCPA::SolveWMod::getTLoss1D(int select_modes, double dz, int n_r, double dr, double z_src, 
