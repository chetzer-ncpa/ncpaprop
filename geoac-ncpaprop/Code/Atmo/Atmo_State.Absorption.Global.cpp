...
double SuthBass_Alpha(double r, double theta, double phi, double freq){
    ...
    // O2 profile
    if ((r-r_earth) > 90.)    X[0] = pow(10.0,49.296-(1.5524*(r-r_earth))+(1.8714E-2*pow(r-r_earth,2))-(1.1069E-4*pow(r-r_earth,3))+(3.199E-7*pow(r-r_earth,4))-(3.6211E-10*pow(r-r_earth,5)));
    ...
    else            X[3] = pow(10.0,-19.027+(1.3093*(r-r_earth))-(4.6496E-2*pow(r-r_earth,2))+(7.8543E-4*pow(r-r_earth,3))-(6.5169E-6*pow(r-r_earth,4))+(2.1343E-8*pow(r-r_earth,5)));
    ...
    // N profile
    X[5]  = pow(10.0,-53.746+(1.5439*(r-r_earth))-(1.8824E-2*pow(r-r_earth,2))+(1.1587E-4*pow(r-r_earth,3))-(3.5399E-7*pow(r-r_earth,4))+(4.2609E-10*pow(r-r_earth,5)));
        
    // H20 profile
    if ((r-r_earth) > 30. )   X[6] = pow(10.0,-4.2563+(7.6245E-2*(r-r_earth))-(2.1824E-3*pow(r-r_earth,2))-(2.3010E-6*pow(r-r_earth,3))+(2.4265E-7*pow(r-r_earth,4))-(1.2500E-09*pow(r-r_earth,5)));
    else{  if ((r-r_earth) > 100.)   X[6] = pow(10.0,-0.62534-(8.3665E-2*(r-r_earth)));
           else                         X[6] = pow(10.0,-1.7491+(4.4986E-2*(r-r_earth))-(6.8549E-2*pow(r-r_earth,2))+(5.4639E-3*pow(r-r_earth,3))-(1.5539E-4*pow(r-r_earth,4))+(1.5063E-06*pow(r-r_earth,5)));
    }
